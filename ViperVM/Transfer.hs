...
-- CL --> Host
checkLink (CLLink _ _ m1 HostMemory) (View1D (CLBuffer _ _ m1b _) _ _) (View1D (HostBuffer {}) _ _) = m1 == m1b
checkLink (CLLink _ _ m1 HostMemory) (View2D (CLBuffer _ _ m1b _) _ _ _ _) (View2D (HostBuffer {}) _ _ _ _) = m1 == m1b
-- Host --> CL
checkLink (CLLink _ _ HostMemory m1) (View1D (HostBuffer {}) _ _) (View1D (CLBuffer _ _ m1b _) _ _) = m1 == m1b
checkLink (CLLink _ _ m1 HostMemory) (View2D (HostBuffer {}) _ _ _ _) (View2D (CLBuffer _ _ m1b _) _ _ _ _) = m1 == m1b
-- CL --> CL
checkLink (CLLink _ _ m1 m2) (View1D (CLBuffer _ _ m1b _) _ _) (View1D (CLBuffer _ _ m2b _) _ _) = m1 == m1b && m2 == m2b
checkLink (CLLink _ _ m1 m2) (View2D (CLBuffer _ _ m1b _) _ _ _ _) (View2D (CLBuffer _ _ m2b _) _ _ _ _) = m1 == m1b && m2 == m2b
-- Default
...
performTransfer (Transfer link src dst) = case link of
  ...
  CLLink lib cq HostMemory _ -> case (src,dst) of
    (View1D (HostBuffer _ _ ptr) soff sz, View1D (CLBuffer _ _ _ buf) doff _) -> do
  ...
  CLLink lib cq _ HostMemory -> case (src,dst) of
    (View1D (CLBuffer _ _ _ buf) soff sz, View1D (HostBuffer _ _ ptr) doff _) -> do
